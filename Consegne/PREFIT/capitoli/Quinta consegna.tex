...
\begin{itemize}
    \item [$\Rightarrow$] Non può essere applicato efficaciemente in contesti per cui si richiede uso di specifiche nozioni non derivabili dal ragionamento (perchè frutto di convenzioni);
...
\nt{La fase I è da svolgersi, preferibilmente \evidence{unplugged}, perchè gli studenti, tentando di applicare subito il concetto appreso
