...
\newtcbtheorem[number within=chapter]{wconc}{Wrong Concept}{
	...
	enhanced,
	colback=white,
	colframe=BrownPastel,
	arc=0pt,
	outer arc=0pt,
	fonttitle=\bfseries\sffamily\large,
	colbacktitle=BrownPastel,
	...
	boxed title style={
			...
			arc=3pt,
			bottom=0pt,
			interior style={fill=BrownPastel}
		},
	#1
}{def}
...
{\addvspace{30pt}%
	\begin{tikzpicture}[remember picture, overlay]%
		\draw[fill=BrownPastel,draw=BrownPastel] (-7.3,-.1) rectangle (-0.5,.5);%
		\pgftext[left,x=-3.7cm,y=0.2cm]{\color{white}\Large\sc\bfseries Capitolo\ \thecontentslabel};%
	\end{tikzpicture}\color{BrownPastel}\large\sc\bfseries}%
{}
{}
{\;\titlerule\;\large\sc\bfseries Pagina \thecontentspage
	\begin{tikzpicture}[remember picture, overlay]
		\draw[fill=BrownPastel,draw=BrownPastel] (2pt,0) rectangle (4,0.1pt);
	\end{tikzpicture}}%
