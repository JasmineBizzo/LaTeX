...
{\addvspace{30pt}%
	\begin{tikzpicture}[remember picture, overlay]%
		\draw[fill=blue,draw=blue] (-7.3,-.1) rectangle (-0.5,.5);%
...
{\;\titlerule\;\large\sc\bfseries Pagina \thecontentspage
	\begin{tikzpicture}[remember picture, overlay]
		\draw[fill=blue,draw=blue] (2pt,0) rectangle (4,0.1pt);
	\end{tikzpicture}}%
...
\renewcommand{\tableofcontents}{%
	\chapter*{%
	  \vspace*{-20\p@}%
	  \begin{tikzpicture}[remember picture, overlay]%
		  \pgftext[right,x=15cm,y=0.2cm]{\color{blue}\Huge\sc\bfseries \contentsname};%
		  \draw[fill=blue,draw=blue] (13,-.75) rectangle (20,1);%
