...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=section]{claim}{Asserzione}
{%
	enhanced
	,breakable
	,colback = myg!10
...
{\addvspace{30pt}%
	\begin{tikzpicture}[remember picture, overlay]%
		\draw[fill=red,draw=red] (-7.3,-.1) rectangle (-0.5,.5);%
...
{\;\titlerule\;\large\sc\bfseries Pagina \thecontentspage
	\begin{tikzpicture}[remember picture, overlay]
		\draw[fill=red,draw=red] (2pt,0) rectangle (4,0.1pt);
	\end{tikzpicture}}%
...
\renewcommand{\tableofcontents}{%
	\chapter*{%
	  \vspace*{-20\p@}%
	  \begin{tikzpicture}[remember picture, overlay]%
		  \pgftext[right,x=15cm,y=0.2cm]{\color{red}\Huge\sc\bfseries \contentsname};%
