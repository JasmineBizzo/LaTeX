...
\definecolor{cyanPastel}{RGB}{229, 204, 255}
...
\definecolor{cyaned}{RGB}{127,0,0}
...
%{\parbox{4.5em}{%
%		\hfill\Huge\sffamily\bfseries\color{cyaned}\thecontentspage}%
%	\vspace*{-2.3\baselineskip}\leftbar\textsc{\small\chaptername~\thecontentslabel}\\\sffamily}
%{}{\endleftbar}
%\titlecontents{section}
%[8.4em]
%{\sffamily\contentslabel{3em}}{}{}
%{\hspace{0.5em}\nobreak\itshape\color{cyaned}\contentspage}
...
{\addvspace{30pt}%
	\begin{tikzpicture}[remember picture, overlay]%
		\draw[fill=cyan,draw=cyan] (-7.3,-.1) rectangle (-0.5,.5);%
