...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{1a.1}} & Aggiunge un turno di cucina e , opzionalmente segna un luogo.  & \cellcolor{RedPastel} Non si hanno i permessi necessari. \\\hline
...
\section*{\huge\textbf{\textcolor{2}{Eccezione 1b}}}
...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{1b.1}} & Aggiunge un turno di cucina e , opzionalmente segna un luogo.  & \cellcolor{RedPastel}Esiste già un turno in quel orario. \\\hline
           & \textit{Termina il Caso d'Uso}& \\\hline
            \hline
            \end{longtable}
...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{1a.1a.1}} & Modifica un turno di cucina.  & \cellcolor{RedPastel} Non si hanno i permessi necessari. \\\hline
           & \textit{Termina il Caso d'Uso}& \\\hline
            \hline
            \end{longtable}
...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{1b.1a.1}} & Cancella un turno di cucina.  & \cellcolor{RedPastel} Non si hanno i permessi necessari. \\\hline
           & \textit{Termina il Caso d'Uso}& \\\hline
            \hline
            \end{longtable}
...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{1c.1a.1}} & Modifica tutti i turni di cucina in un determinato giorno, settimana.  & \cellcolor{RedPastel} Non si hanno i permessi necessari. \\\hline
           & \textit{Termina il Caso d'Uso}& \\\hline
            \hline
            \end{longtable}
...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{1d.1a.1}} & Elimina tutti i turni di cucina in un determinato giorno, settimana.  & \cellcolor{RedPastel} Non si hanno i permessi necessari. \\\hline
           & \textit{Termina il Caso d'Uso}& \\\hline
            \hline
            \end{longtable}
...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{5a.1}} &  Opzionalmente, modifica la scadenza. & \cellcolor{RedPastel} Il turno non ha una scadenza impostata.\\\hline
...
\begin{flushleft}
    \begin{center}
        ...
        \begin{longtable}{ | p{1.3cm} | p{7.5cm} | p{7.5cm} |}
            ...
            \centering\textbf{\textcolor{2}{5a.1a}} &  Rimuove la scadenza. & \cellcolor{RedPastel} Il turno non ha una scadenza impostata.\\\hline
